...
return [
    ...
    */
    ...
    'store-product-request' => [
        ...
        'category-id' => [
            'required' => 'Укажите категорию продукта'
        ],
        'base-price' => [
            'required' => 'Укажите базовую цену продукта',
            'numeric' => 'Базовая цена продукта должна быть числом'
        ],
        'materials' => [
            'required' => 'Продукт должен содержать минимум 1 материал'
        ],
    ],
    'store-page-request' => [
        'name' => [
            'required' => 'Укажите название страницы'
        ],
        'desc' => [
            'required' => 'Укажите описание страницы'
        ],
        'categoryId' => [
            'required' => 'Укажите категорию страницы'
        ],
        'elements' => [
            'required' => 'Страница должна содержать минимум 1 блок'
        ],
        'slug' => [
